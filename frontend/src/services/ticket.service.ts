...
export class TicketsService {
  ...
  makeAComment(ticketId: string, comment: string, author: string, authorPhoto: string, type: string, attachmentUrl: string){
    const body = {ticketId, comment, author, authorPhoto, type, attachmentUrl};
