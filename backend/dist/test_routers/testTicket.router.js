...
var _testTicket = require("./testTicket.model");
var _data = require("../../tickets/src/utils/data");
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // import { TicketModel } from "../models/ticket.model";
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _testTicket.TestTicketModel.countDocuments();
        case 2:
        ...
        case 6:
          _testTicket.TestTicketModel.create(_data.sample_tickets).then(function (data) {
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _testTicket.TestTicketModel.find();
        case 2:
...
router.get('/assigned', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
...
router.get('/projects', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
      ...
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          if (tickets.length != 0) {
            ...
            res.status(404).send({
              message: "No tickets for this project"
            });
          }
          _context6.next = 10;
          break;
      ...
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 4:
          ...
          if (tickets.length != 0) {
            ...
            res.status(404).send({
              message: "No tickets found for that group"
            });
          }
          _context7.next = 11;
          break;
  ...
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          _context8.next = 2;
          return _testTicket.TestTicketModel.deleteMany({});
        case 2:
          res.status(200).send({
...
// Add ticket
router.post('/addticket', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 3:
          ...
          newTicket = new _testTicket.TestTicketModel({
  ...
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          _context10.next = 2;
          return _testTicket.TestTicketModel.findOne({
            id: req.query.id
          });
        case 2:
...
router.put('/comment', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          ...
          _context11.prev = 7;
          _context11.next = 10;
          return _testTicket.TestTicketModel.findOneAndUpdate({
            id: ticketId
          }, {
            $push: {
              comments: newComment
...
router.put('/updateStatus', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
...
router.post('/addTimeToFirstResponse', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        ...
        case 5:
          ...
          res.status(200).send({
            message: "Time to first response added"
          });
          _context13.next = 12;
          return ticket.save();
        case 12:
        ...
        case 15:
          if (ticket.timeToFirstResponse) {
            res.status(200).send({
              message: "First response time already recorded"
            });
          }
        case 16:
          _context13.next = 21;
...
router.put('/updateTodoChecked/:id', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
