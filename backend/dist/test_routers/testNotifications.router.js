...
var _test_notifications_sample = require("../test_samples/test_notifications_sample");
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          _testNotifications.TestNotificationsModel.create(_test_notifications_sample.sample_notifications).then(function (data) {
